...
const IN: ZoneCode[] = ['s', 'r', 'l', 'o', 'w', 'd', 'b', 'v', 'm', 'k', 'p'];
const PUBLIC_IN: ZoneCode[] = ['s', 'r', 'l', 'v', 'b'];
const OUT: ZoneCode[] = ['a', 'g', 'x', '.'];
const DESKS: ZoneCode[] = ['s', 'r', 'o', 'm', 'v'];
...
export const OBJECTS: ObjDef[] = [
  ...
  { id: 'financedesk', name: 'Finance desk', icon: '🏦', category: 'showroom', w: 2, h: 2, cost: 1800, upkeep: 20, power: 1, zones: DESKS, station: ['accountant', 'sales'], effects: { finance: 1, sales: 2 }, tags: ['desk', 'bureau', 'loan', 'finance'], color: '#9b8cff', description: 'Where buyers sign finance agreements. More of them take finance through you.' },
  { id: 'receptiondesk', name: 'Reception desk', icon: '🛎️', category: 'showroom', w: 3, h: 1, cost: 1600, upkeep: 8, power: 1, zones: ['r', 's', 'v'], effects: { reception: 1 }, tags: ['desk', 'welcome', 'counter', 'balie', 'receptie'], color: '#d9c7a8', description: 'Customers are greeted and wait longer before giving up.' },
  { id: 'welcomecounter', name: 'Welcome counter', icon: '🛎️', category: 'showroom', w: 4, h: 2, cost: 4200, upkeep: 20, power: 2, zones: ['r', 's'], effects: { reception: 1, satisfaction: 3, appeal: 0.5 }, minLevel: 2, tags: ['desk', 'reception', 'receptie', 'counter', 'balie'], color: '#e6dccb', description: 'A large curved welcome counter. First impressions count.' },
  ...
  // ------------------------------------------------------------------ office
  { id: 'officedesk', name: 'Office desk', icon: '🗂️', category: 'office', w: 2, h: 2, cost: 700, upkeep: 4, power: 1, zones: ['o', 'm'], station: ['manager', 'accountant', 'buyer', 'marketing'], tags: ['desk', 'bureau', 'buyer', 'accountant', 'marketing'], color: '#8b949e', description: 'A desk for a manager, buyer, accountant or marketing specialist.' },
  { id: 'managerdesk', name: 'Manager’s desk', icon: '👔', category: 'office', w: 3, h: 2, cost: 3200, upkeep: 25, power: 1, zones: ['m', 'o'], station: ['manager'], effects: { management: 2, morale: 0.5 }, minLevel: 2, tags: ['desk', 'bureau', 'manager', 'executive'], color: '#5b4b8a', description: 'An executive desk. The manager who sits here keeps the whole team sharper.' },
  ...
  // ----------------------------------------------------------------- service
  { id: 'lift', name: 'Workshop lift', icon: '🔧', category: 'service', w: 4, h: 6, cost: 5500, upkeep: 55, power: 6, zones: ['w'], slot: 'lift', station: ['mechanic'], effects: { workshop: 1 }, tags: ['repair', 'mechanic', 'bay', 'hefbrug', 'werkplaats'], color: '#ffc233', description: 'A repair bay. Each lift works on one car and is a workstation for a mechanic.' },
  ...
  { id: 'workbench', name: 'Workbench', icon: '🪚', category: 'service', w: 2, h: 1, cost: 600, upkeep: 2, power: 0, zones: ['w', 'd', 'p'], effects: { service: 1 }, tags: ['bench', 'tools', 'table'], color: '#8a6a4a', description: 'Somewhere to strip down parts. Service gets quicker.' },
  ...
  { id: 'washbay', name: 'Detailing bay', icon: '🧽', category: 'service', w: 4, h: 6, cost: 3200, upkeep: 30, power: 4, zones: ['d'], slot: 'bay', station: ['detailer'], effects: { detailing: 1 }, tags: ['wash', 'clean', 'wasstraat', 'detailer', 'detailing'], color: '#3cc7ff', description: 'Cleaning and detailing station for one car. A workstation for a detailer.' },
  ...
  { id: 'photostudio', name: 'Photo studio', icon: '📸', category: 'service', w: 5, h: 6, cost: 9000, upkeep: 30, power: 4, zones: ['d', 's'], effects: { detailing: 1, photo: 1 }, minLevel: 3, tags: ['photos', 'camera', 'marketing'], color: '#eef1f4', description: 'Professional photos for every online listing, free.' },
  ...
  { id: 'servicedesk', name: 'Service desk', icon: '🧾', category: 'service', w: 2, h: 2, cost: 1600, upkeep: 10, power: 1, zones: ['v', 'r'], effects: { service: 1.5, satisfaction: 1 }, tags: ['desk', 'bureau', 'service', 'balie'], color: '#8f9aa6', description: 'Where work is booked in. Keeps the workshop organised.' },
  ...
  { id: 'securitybooth', name: 'Security booth', icon: '💂', category: 'security', w: 2, h: 2, cost: 4500, upkeep: 40, power: 2, zones: ['a', 't', 'x'], effects: { security: 3 }, minLevel: 2, tags: ['guard', 'beveiliging'], color: '#51606f', description: 'A guarded booth for the lot. Big insurance savings on large stock.' },
];
