...
export const OBJECTS: ObjDef[] = [
  ...
  // ------------------------------------------------------------------ office
  { id: 'officedesk', name: 'Office desk', icon: '🗂️', category: 'office', w: 2, h: 2, cost: 700, upkeep: 4, power: 1, zones: ['o', 'm'], station: ['manager', 'accountant', 'buyer', 'marketing', 'inventory', 'admin', 'procurement', 'hr', 'logistics'], tags: ['desk', 'bureau', 'buyer', 'accountant', 'marketing', 'inventory'], color: '#8b949e', description: 'A desk for a manager, buyer, accountant or marketing specialist.' },
  ...
  { id: 'cubicle', name: 'Office cubicle', icon: '🗂️', category: 'office', w: 2, h: 2, cost: 850, upkeep: 4, power: 1, zones: ['o', 'm', 'n', 'u'], station: ['admin', 'buyer', 'marketing', 'accountant', 'inventory', 'procurement', 'hr', 'logistics'], effects: { management: 0.2 }, tags: ['desk', 'bureau', 'office', 'workstation'], color: '#9aa3ad', description: 'A screened desk for back-office staff. Quieter than an open desk.' },
  // ---------------------------------------------------- v6: showroom
  ...
  { id: 'palletrack', name: 'Pallet racking', icon: '🏗️', category: 'storage', w: 4, h: 1, cost: 900, upkeep: 2, power: 0, zones: ['p', 't', 'w'], effects: { logistics: 0.3, service: 0.2 }, tags: ['pallet', 'pallets', 'racking', 'stelling', 'opslag', 'storage'], color: '#c98a3b', description: 'Tall racking for pallets of oil, fluids and bulk parts. Deliveries are unpacked faster.' },
  { id: 'container', name: 'Storage container', icon: '📦', category: 'storage', w: 3, h: 2, cost: 1400, upkeep: 3, power: 0, zones: ['t', 'a'], effects: { logistics: 0.4 }, tags: ['container', 'storage', 'opslag', 'yard'], color: '#3f7f8f', description: 'A lockable steel container in the yard for seasonal stock and spare wheels.' },
  { id: 'partsbins', name: 'Parts bin wall', icon: '🗃️', category: 'storage', w: 2, h: 1, cost: 450, upkeep: 1, power: 0, zones: ['p', 'w', 't'], effects: { service: 0.4 }, tags: ['parts', 'bins', 'onderdelen', 'storage', 'small parts'], color: '#8a6b3f', description: 'Labelled bins for bolts, clips and filters: mechanics find small parts at once.' },
  // ---------------------------------------------------- v6: decoration
