...
export const OBJECTS: ObjDef[] = [
  ...
  // ---- dealership extras
  { id: 'premiumdesk', name: 'Premium sales desk', icon: '🧑‍💼', category: 'work', w: 3, h: 2, cost: 2200, upkeep: 10, power: 2, zones: ['s', 'r', 'o'], station: ['sales'], effects: { appeal: 0.6, reception: 0.3 }, color: '#d6b36a', description: 'Premium consultation desk with an upscale feel. One salesperson can work here.' },
  { id: 'managerdesk', name: 'Manager workstation', icon: '🧑‍💻', category: 'work', w: 2, h: 2, cost: 1800, upkeep: 8, power: 1, zones: ['o'], station: ['manager'], effects: { decor: 0.3 }, color: '#697586', description: 'Dedicated workstation for the dealership manager.' },
  { id: 'financecounter', name: 'Finance counter', icon: '💳', category: 'work', w: 2, h: 2, cost: 2600, upkeep: 10, power: 2, zones: ['s', 'r', 'o'], station: ['sales'], effects: { reception: 0.5, appeal: 0.4 }, color: '#4f8fba', description: 'Customer-facing finance point for financing and warranty conversations.' },
  { id: 'coffeebar', name: 'Coffee bar', icon: '☕', category: 'furniture', w: 3, h: 2, cost: 1800, upkeep: 18, power: 3, zones: ['l', 'r', 's'], effects: { lounge: 2, reception: 0.4 }, color: '#6f4b35', description: 'A proper coffee bar that makes the waiting area more comfortable.' },
  { id: 'displaywall', name: 'Vehicle display wall', icon: '🚘', category: 'decor', w: 4, h: 1, cost: 2800, upkeep: 12, power: 3, zones: ['s', 'r'], effects: { appeal: 1.2, decor: 1 }, color: '#4b5563', description: 'Branded wall showing featured vehicles and current promotions.' },
  { id: 'digitaltotem', name: 'Digital info totem', icon: '🖥️', category: 'decor', w: 1, h: 2, cost: 1900, upkeep: 8, power: 2, zones: ['s', 'r', 'a'], effects: { appeal: 0.7, footfall: 0.2 }, color: '#3cc7ff', description: 'Interactive vehicle information customers can browse themselves.' },
  { id: 'brandlogo', name: 'Wall logo', icon: '🔶', category: 'decor', w: 2, h: 1, cost: 700, upkeep: 1, power: 0, zones: ['s', 'r', 'o'], effects: { decor: 0.8, appeal: 0.3 }, color: '#ff7a1a', description: 'Large dealership logo that strengthens the showroom identity.' },
  { id: 'flowerbed', name: 'Flower bed', icon: '🌺', category: 'exterior', w: 3, h: 1, cost: 450, upkeep: 4, power: 0, zones: ['g', 'a'], effects: { curb: 0.8, footfall: 0.2 }, color: '#d96a8b', description: 'Landscaped flowers that improve the entrance and curb appeal.' },
  { id: 'bollards', name: 'Safety bollards', icon: '🚧', category: 'exterior', w: 2, h: 1, cost: 550, upkeep: 1, power: 0, zones: ['a', 'g'], effects: { security: 0.5, curb: 0.2 }, color: '#ffc233', description: 'Protects the frontage and gives the entrance a finished look.' },
  { id: 'evdisplay', name: 'EV charging hub', icon: '⚡', category: 'vehicles', w: 2, h: 2, cost: 4200, upkeep: 30, power: 10, zones: ['a', 's'], effects: { ev: 2, appeal: 0.5 }, color: '#2fd18b', description: 'Larger charging point for modern EV stock with stronger EV appeal.' },
