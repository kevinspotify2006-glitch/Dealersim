...
export const OBJECTS: ObjDef[] = [
  ...
  // ------------------------------------------------------------------ office
  { id: 'officedesk', name: 'Office desk', icon: '🗂️', category: 'office', w: 2, h: 2, cost: 700, upkeep: 4, power: 1, zones: ['o', 'm'], station: ['manager', 'accountant', 'buyer', 'marketing', 'inventory'], tags: ['desk', 'bureau', 'buyer', 'accountant', 'marketing', 'inventory'], color: '#8b949e', description: 'A desk for a manager, buyer, accountant or marketing specialist.' },
  { id: 'managerdesk', name: 'Manager’s desk', icon: '👔', category: 'office', w: 3, h: 2, cost: 3200, upkeep: 25, power: 1, zones: ['m', 'o'], station: ['manager', 'inventory'], effects: { management: 2, morale: 0.5 }, minLevel: 2, tags: ['desk', 'bureau', 'manager', 'executive'], color: '#5b4b8a', description: 'An executive desk. The manager who sits here keeps the whole team sharper.' },
