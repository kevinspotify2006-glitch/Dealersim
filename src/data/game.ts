...
export const ROLES: RoleDef[] = [
  { id: 'sales', name: 'Salesperson', icon: '🤝', baseSalary: 2300, description: 'Handles customers you do not serve yourself and improves negotiation outcomes.', specializations: ['Luxury', 'Family', 'EV', 'Sports', 'Closer', 'Trade-ins'], skill: 'sales', minLevel: 1, station: 'a sales desk' },
  ...
  { id: 'buyer', name: 'Buyer', icon: '🔎', baseSalary: 2800, description: 'Finds more and cheaper market offers, spots risky cars and builds supplier relationships.', specializations: ['Auctions', 'Private sales', 'Premium', 'Classics'], skill: 'negotiation', minLevel: 1, station: 'an office desk' },
  { id: 'manager', name: 'Manager', icon: '🧭', baseSalary: 3800, description: 'Keeps staff motivated, boosts the sales team and lets the location run itself (auto-pricing & listing).', specializations: ['Operations', 'People', 'Growth'], skill: 'management', minLevel: 1, station: 'an office or manager\'s desk' },
  ...
  { id: 'finance', name: 'Finance Manager', icon: '🏦', baseSalary: 3400, description: 'Structures loans and leases, gets more applications approved and sells protection products.', specializations: ['Leasing', 'Credit repair', 'Insurance'], skill: 'finance', minLevel: 2, station: 'a finance desk' },
  ...
  { id: 'technician', name: 'Technician', icon: '🛠️', baseSalary: 2900, description: 'Diagnoses faults and services EVs and complex cars, faster than a general mechanic.', specializations: ['EV systems', 'Diagnostics', 'Electronics'], skill: 'technical', minLevel: 2, station: 'a lift or workbench' },
...
export const SKILL_NAMES: Record<SkillId, string> = {
  sales: 'Sales', negotiation: 'Negotiation', finance: 'Finance', service: 'Customer service', technical: 'Technical',
