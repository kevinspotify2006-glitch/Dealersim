...
export const ARCHETYPES: Archetype[] = [
  ...
  { id: 'family', name: 'Family buyer', icon: '👨‍👩‍👧', budget: [12000, 34000], bodies: ['Wagon', 'SUV', 'Van', 'Sedan'], categories: ['Family', 'SUV', 'Van', 'Compact'], fuels: ['Petrol', 'Diesel', 'Hybrid', 'Electric'], maxMileage: 160000, minYearAge: 12, priceSensitivity: 0.65, patience: [3, 5], negotiation: [0.3, 0.6], tradeInChance: 0.55, extrasAffinity: 0.7, weight: 1.2 },
  { id: 'young', name: 'Young driver', icon: '🧢', budget: [5000, 16000], bodies: ['Hatchback', 'Coupe', 'Roadster', 'Convertible'], categories: ['Economy', 'Compact', 'Sport'], fuels: ['Petrol', 'Hybrid', 'Diesel'], maxMileage: 200000, minYearAge: 16, priceSensitivity: 0.75, patience: [2, 4], negotiation: [0.2, 0.5], tradeInChance: 0.15, extrasAffinity: 0.3, weight: 0.9 },
  ...
  { id: 'firsttime', name: 'First-time buyer', icon: '🔑', budget: [4000, 12000], bodies: ['Hatchback', 'Sedan'], categories: ['Economy', 'Compact'], fuels: ['Petrol', 'Hybrid', 'Diesel', 'Electric'], maxMileage: 180000, minYearAge: 15, priceSensitivity: 0.7, patience: [3, 5], negotiation: [0.1, 0.35], tradeInChance: 0.02, extrasAffinity: 0.6, weight: 1.0 },
  ...
  { id: 'suv', name: 'SUV buyer', icon: '🚙', budget: [14000, 60000], bodies: ['SUV', 'Pickup'], categories: ['SUV', 'Premium', 'Luxury', 'Electric'], fuels: ['Petrol', 'Diesel', 'Hybrid', 'Electric'], maxMileage: 150000, minYearAge: 12, priceSensitivity: 0.55, patience: [3, 5], negotiation: [0.3, 0.7], tradeInChance: 0.5, extrasAffinity: 0.5, weight: 1.0 },
  { id: 'ev', name: 'EV buyer', icon: '⚡', budget: [15000, 70000], bodies: ['Hatchback', 'Sedan', 'SUV', 'Coupe'], categories: ['Electric'], fuels: ['Electric', 'Hybrid'], maxMileage: 120000, minYearAge: 7, priceSensitivity: 0.55, patience: [3, 5], negotiation: [0.3, 0.6], tradeInChance: 0.45, extrasAffinity: 0.55, weight: 0.6 },
  { id: 'commuter', name: 'Practical commuter', icon: '🚆', budget: [7000, 22000], bodies: ['Hatchback', 'Sedan', 'Wagon'], categories: ['Economy', 'Compact', 'Family', 'Electric'], fuels: ['Diesel', 'Hybrid', 'Petrol', 'Electric'], maxMileage: 200000, minYearAge: 14, priceSensitivity: 0.7, patience: [2, 5], negotiation: [0.3, 0.6], tradeInChance: 0.4, extrasAffinity: 0.4, weight: 1.2 },
];
