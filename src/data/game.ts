...
export const ROLES: RoleDef[] = [
  ...
  { id: 'hr', name: 'HR Manager', icon: '🧑‍💼', baseSalary: 3600, description: 'Looks after a group of employees for you: plans their training, promotes them when they are ready, keeps pay fair, covers absences and asks the headhunter for replacements. Capacity grows with their level.', specializations: ['Development', 'Recruitment', 'Wellbeing'], skill: 'management', minLevel: 2, station: 'an office desk' },
  { id: 'logistics', name: 'Logistics Manager', icon: '🚚', baseSalary: 3300, description: 'Runs your transport: picks up bought cars sooner, moves stock between locations and keeps the fleet busy and cheap.', specializations: ['Transport', 'Warehousing', 'Routing'], skill: 'management', minLevel: 3, station: 'an office desk' },
