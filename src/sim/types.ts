...
export type ZoneCode = '.' | 'a' | 's' | 'w' | 'd' | 'o' | 'l' | 'r' | 't' | 'g' | 'x' | 'b' | 'v' | 'm' | 'k' | 'p' | 'e' | 'f';
...
export interface GameState {
  ...
  kpi: { waitHours: number; waitCount: number; financeDeals: number; financeOffers: number; productsSold: number; serviceRevenue: number; partsRevenue: number; financeIncome: number; deliveries: number };
