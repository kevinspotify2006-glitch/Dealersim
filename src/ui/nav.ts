...
export const SECTIONS: NavSection[] = [
  ...
  { id: 'management', label: 'Management', short: 'Manage', icon: 'gauge', routes: ['management'] },
  { id: 'settings', label: 'Settings', short: 'Settings', icon: 'settings', routes: ['settings'] },
];

/** Phones: these sections live behind the sixth "More" tab instead of the bar. */
export const MORE_SECTIONS = ['management', 'settings'];
