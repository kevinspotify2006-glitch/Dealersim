...
const need = ['automation', 'headhunter', 'logistics', 'procurement', 'appointments', 'economy', 'funnel', 'clients', 'serviceJobs', 'contracts', 'research', 'decisions', 'fleet', 'missions', 'group', 'suppliers', 'branding', 'kpi', 'boosts'];
