...
**Build Mode 2.0 (v7.2) — room-based building.** Build opens on the dealership, not on a catalogue. Tap a room on the map (or pick it from the overview) and the drawer shows only that room's categories and items:

| Room | Categories |
|---|---|
| Showroom | Furniture · Cars · Sales · Electronics · Decoration · Lighting · Storage · Walls & doors |
| Customer area (reception, lounge, service desk, finance, delivery) | Seating · Tables · Coffee & drinks · Entertainment · Desks & counters · Facilities · Decoration · Lighting · Walls & doors |
| Office (offices, manager, marketing, training, staff room) | Desks · Chairs · Computers · Meeting · Break room · Storage · Decoration · Lighting · Walls & doors |
| Workshop (workshop, detailing) | Workbenches · Lifts · Tools · Diagnostics · Tyres · Parts · Detailing · Safety · Lighting · Walls & doors |
| Storage (parts store, storage yard) | Shelving · Cabinets · Pallets · Parts storage · Containers · Car storage · Safety · Walls & doors |
| Outdoor | Parking · Roads (drawn) · Car spots · Charging · Greenery · Lighting · Signs · Entrances · Decoration |

- The selected room is outlined in blue (the rest dims a little) and the camera glides to it. Items are cards (art, name, price, size, main effect; locked items say why). Choosing one starts placement: the preview appears on a free spot in that room (wall items look for a wall), turns green or red with the reason ("belongs in: Workshop", "Not enough cash", "is in the way"…), and **Place** builds it — money is paid, the room's state updates, it is saved, and the menu stays open for the next one.
- Desktop: room menu on the left, a details panel on the right while placing (price, size, effects, upkeep, placement type, allowed rooms, requirement, Place / Rotate / Cancel), mouse to aim, **R** rotate, **Enter** place, **Esc** cancel, **Delete** remove. Phone: the menu is a bottom sheet with one row of categories and a horizontal tray of cards; placing folds it away for a Rotate / Cancel / Place bar.
- The room data lives in `src/data/buildrooms.ts`: each room type lists its categories and the item ids in them; an item's *allowed rooms* are derived from that list and its floor types. `Rooms & floors`, `Style & focus`, `Land`, `Templates` and `All items` (search and filters across everything) remain available from the overview.

**Management & automation (v7.3) — run the company, not every car.** A new **Management** section (sidebar on desktop, **More** on a phone) holds the Management Center:

- **Manual / Assisted / Auto per department** — procurement, inventory & pricing, sales, service, parts, HR, logistics and marketing — set for the whole group (HQ policy) or per location, with *All manual / All assisted / All automated* and *Apply HQ policy to every location*. Manual: you do it. Assisted: managers prepare and flag, you decide. Auto: they act within your policy.
- **Policies:** stock thresholds (start buying below, stop at, maximum), max price, minimum margin, risk, segments, fuel, mileage, *buy without asking up to*, monthly purchase budget; reprice after N days and clear to the trade after M days; pricing (conservative, market, aggressive, premium, maximum profit, fast turnover); sales minimum margin, maximum discount, finance and an approval limit; workshop conflict fixing; parts minimum/target factors and express; marketing budget, minimum ROI and channels; logistics pick-up and stock balancing.
- **Automation engine:** a data-driven list of IF → THEN rules (`src/sim/systems/automation.ts`), run highest priority first (critical, high, normal, low) for every location. Each department is run by its best-placed manager: their quality sets how many tasks they get through a day and how often they make mistakes (overpaying, over-discounting, the wrong course). Your own rules (*IF cars on sale > 60 days > 3 THEN cut prices 5%*, *IF stock < 5 THEN start buying*, *IF customers waiting > 3 THEN tell me* …) run after them with a cooldown.
- **Exceptions and approvals:** what managers cannot or may not do lands in the Overview, sorted by priority, with a button to the right screen; critical and high ones also reach the notifications. Deals outside the sales policy or above your limit wait two days for your yes or no. A car you priced by hand keeps its price until you hand it back.
- **Costs:** €120 a month per automated department per location, the headhunter's retainer and fees, the fleet's running costs and the training, marketing and purchase budgets — all on the Finance tab.
- **Reports:** a daily management report per department (kept 35 days), weekly and monthly totals, and a weekly summary notice; automated sales are reported once a day instead of one notice per car.
- **Managers:** the hierarchy from you (CEO) to general management, department managers per location (quality and error rate), team leaders (level 3+) and the team.
- **HR managers** (new role): each looks after 10, 15, 25, 40, 60, 100, 150, 250, 500 or 1,000 people by HR grade 1–10. Their people are off sick less; with **AUTO MANAGE** they train within the budget, promote against your thresholds (skill, performance, months), review pay monthly, give days off before burn-out, recruit to your target headcount per role and location and replace people who leave. Dashboard: coverage, morale, performance, absence, training, vacancies.
- **Headhunter** (People → Headhunter, or Management): five agency levels from a local recruiter to executive search — more searches at once, more candidates, better fit with your brief (role, minimum skill, max salary, experience, age, contract, specialisation and, from level 3, reliability / stress resistance / detail), salary negotiation, people poached from rivals (level 4) and senior managers (level 5). Search fee per brief, success fee on a hire.
- **Logistics** (new role and fleet): delivery vans, transport trucks, car carriers and a regional logistics centre with capacity, running costs, reliability and wear. Your fleet collects bought cars sooner, moves cars between locations for less than a carrier and balances stock automatically.
- **Notifications:** filter by Critical, Important, Info or Automation, and group similar notices.

**Mobile & landscape (v7.3).** One layout utility (`src/ui/layout.ts`: `isMobilePortrait`, `isMobileLandscape`, `isTablet`, `isDesktop`) decides the layout and puts it on `<body>` (`lay-portrait`, `lay-landscape`, `lay-tablet`, `lay-desktop`). Portrait: six bottom tabs — Dealership, Inventory, People, Service, Business, More — and bottom sheets. Landscape (Galaxy S25 Ultra sideways and similar): a navigation rail on the left, the dealership in the middle, a context panel on the right for whatever you select, quick actions along the bottom, and dialogs as a full-height drawer from the right. Build mode sideways: rooms and categories on the left, the world in the middle, the item details on the right and the placement controls along the bottom. Rotating re-lays out the current screen without a reload; the APK supports both orientations and stays immersive.
...
npm test            # build + headless simulation + v7.3 management checks (headhunter, HR capacity/training/promotion/recruitment, procurement thresholds, inventory, sales policy and approvals, logistics, parts, rules, costs, saves) + room-based build checks (every item has a room, rooms only offer what belongs there, room rules, money, rotation, save/load) (six companies play 240 days; economy and save invariants) + build-system checks (catalogue, bulldoze refunds, area bulldoze, upgrades, land, every room template in both rotations, styles, flows) + test-drive checks (every route driven to the finish by four cars, handling differences, brakes, steering, collisions, resets, timer) + migration of version-3, -4 and -5 saves
npm run test:e2e    # Playwright: the v7.3 Management Center and layouts (portrait 360/390/412/480, landscape 800/891/900, rotation, 1080+), full playthroughs (desktop and phone), edge flows, the v4 systems through the UI (research, pricing, delivery, parts, campaigns, staff, fleet, decisions, demo cars, identity, finance, test drives), the v5 systems (six-section navigation and swipe, status bar, vehicle buyers from brief to approval and from a notification, planning drag / move / conflict fix, contracts, customer mood and assigning an advisor), build-mode QA with mouse and touch, the v6 systems (Build / Move / Bulldoze / Area modes, refund and safety dialogs, undo/redo, buying locked land on the map, templates, create room, upgrades, styles, and the test drive with keyboard and touch controls, checkpoints, result, buy after the drive and a customer drive), build-tab clipping at desktop, laptop, tablet and Galaxy S25 Ultra portrait/landscape, every screen at four sizes (no sideways scroll, every screen reachable in ≤ 3 taps), the v7.2 room-based Build Mode on desktop and phone (rooms overview, tap a room on the map, only that room's categories and items, place with money and rules, rotate, cancel, workshop and outdoor menus, roads, move and remove, save/reload), and the v7 mobile UI (compact header and status sheet, play/pause, notification center, drag-to-close sheets, bottom navigation, group picker, build mode as its own state with top bar, three modes, sheet sizes, search, filter sheet, locked items, insufficient funds and the placement bar)
...
- Save format 8 (v7.3) adds automation policies, exceptions, approvals, reports, rules, the headhunter and the logistics fleet; older saves load with every department on manual.
