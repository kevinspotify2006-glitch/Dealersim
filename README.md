...
| **Test drives** | Choose who goes along, a short or long route (time, wear, the chance they find a fault) and a demo car of the same model to spare the car you sell. |
...
| **Dealership (physical)** | A tile grid of land. 18 room types (showroom, reception, lounge, finance office, delivery area, office, manager office, workshop, service reception, detailing, parts, toilets, staff room, storage, lot, walkways, landscaping, bare land) and **129 placeable objects** with size, rotation, cost, upkeep, power, capacity, audience, unlock level, effects and 20 layout synergies (a finance desk next to a sales desk, coffee near seating, a service desk near lifts…). |
| **Build mode** | 18 categories that never get cut off (they wrap on wide screens and scroll with arrows on phones): All, Rooms, Structure, Showroom, Vehicles, Customers, Staff, Service, Finance, Marketing, Storage, Decoration, Exterior, Parking, EV, Technology, Security, Premium — plus floors & ceilings, land and templates. Search matches names, categories, descriptions, tags, effects, functions, roles, rooms, unlocks, prices (`<500`, `>5000`) and car types; 13 filters; tooltips with price, size, unlock, upkeep, capacity, effects, synergy, requirements, who it matters to and who uses it. Drag and drop, ghost previews, snap, grid, undo/redo, copy/paste, templates, and cars dragged onto the floor. |
...
npm test            # build + headless simulation (six companies play 240 days; economy and save invariants) + migration of version-3 and version-4 saves
npm run test:e2e    # Playwright: full playthroughs (desktop and phone), edge flows, the v4 systems through the UI (research, pricing, delivery, parts, campaigns, staff, fleet, decisions, demo cars, identity, finance, test drives), the v5 systems (six-section navigation and swipe, status bar, vehicle buyers from brief to approval and from a notification, planning drag / move / conflict fix, contracts, customer mood and assigning an advisor), build-mode QA with mouse and touch, build-tab clipping at desktop, laptop, tablet and Galaxy S25 Ultra portrait/landscape, and every screen at four sizes (no sideways scroll, every screen reachable in ≤ 3 taps)
...
tools/qa/              simulation test, save migration (v3 and v4 fixtures), smoke test, playthroughs, edge flows, v4 and v5 flows, build-mode QA, build-tab clipping, all-screens QA, perf check
